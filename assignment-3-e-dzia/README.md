...
1. (2 point) **Data.** Using appropriate python module acquire Twitter (with all features that allows accomplishment of all three tasks) dataset pertaining to a controversy of choice, identified through a hashtag (eg. blitzchung, tasmyNeumanna, listabrakujacychlekow, Srebrna etc)
